...
7. **Avoid cognitive overload** — Text is "signpost" not "full text"; ≤6 elements per slide
8. **Distraction test** — A distracted viewer should still grasp the point from the slide alone
9. **Iterate through practice** — Rehearse to confirm flow and transitions
10. **Design for disaster** — PDF backup, screenshots instead of video, avoid animations
...
**Source:** [Penn State Assertion-Evidence Research](https://writing.engr.psu.edu/ae_comprehension.pdf)
...
**Sources:**
- [InnerDrive: PowerPoint and Cognitive Load](https://www.innerdrive.co.uk/blog/tracking-powerpoint-attention/)
- [Ethos3: Cognitive Load Theory for Presentations](https://ethos3.com/cognitive-load-theory-explained-for-presentations/)
- [Chartered College: CLT for Slideshow Presentations](https://my.chartered.college/impact_article/using-cognitive-load-theory-to-improve-slideshow-presentations/)
...
**Sources:**
- [We And The Color: Design Forecast 2026](https://weandthecolor.com/design-forecast-2026-color-palettes-typography-youll-see-first/205925)
- [Pitch Deck Studios: Presentation Trends 2025](https://www.pitchdeckstudios.com/presentation-trends-2025-bold-colors-big-fonts-and-breaking-the-mold/)
...
- [Fontfabric: Design & Typography Trends 2026](https://www.fontfabric.com/blog/10-design-trends-shaping-the-visual-typographic-landscape-in-2026/)
...
Five viral layouts:
1. **Hero** — Full-bleed image + overlay text
2. **Contrast** — Before/after or dual-panel
3. **Icon Grid** — 3-6 icons with short labels
4. **Quote Focus** — Large quote + attribution
5. **Process Flow** — Step-by-step horizontal or vertical
...
**Source:** [Sabrina Ramonov: Viral PowerPoints](https://www.sabrina.dev/p/viral-powerpoints-slides-free-notebooklm)
